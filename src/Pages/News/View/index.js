...
const View = () => {
  ...
  useEffect(() => {
    if (success && success.type == "news_paragraph_success") {
      toast.success("News Paragraph Added");
      navigate(`/news/paragraph/list/${id}`);
    } else if (success && success.type == "news_media_success") {
      toast.success("News Media Added");
      navigate(`/news/media/list/${id}`);
    } else if (error) {
  ...
  const onMediaSubmit = (fieldsValue) => {
    ...
    data.append("model_name", "News");
    data.append("model_id", id);

    fileList.forEach((file) => {
      data.append("the_file", file);
    });
    dispatch(addNewsMedia(accessToken, data));
  };
  ...
  const onParagraphSubmit = (fieldsValue) => {
    ...
    data.model_id = id;
    data.model_name = "News";

    dispatch(addNewsParagraph(accessToken, data));
  };
